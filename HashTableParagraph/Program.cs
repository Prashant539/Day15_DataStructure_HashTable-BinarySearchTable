...
namespace HashTableParagraph
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("9nd index value: " + hash9);
            string hash10 = hash.Get("10");
            Console.WriteLine("10rd index value: " + hash10);
            ...
            Console.WriteLine("15nd index value: " + hash15);
            string hash16 = hash.Get("16");
            Console.WriteLine("16rd index value: " + hash16);
